...
| Sep 21   | Inhibition. Integration. Ethology. Reflexes. Escape in fish. | Zooniverse lab (tbc)                             | M-cell review paper. Trying to be random. PAPER: M-cell in goldfish. |
| Sep 28   | Neurotransmitters. Central pattern  generators. STG. Locomotion. | Leech lab?                                       | UT s1ch0, s1ch6. List of neurotransmitters. CPG review paper. |
| Oct  5   | Intro to senses. Types of neural coding. Chemical senses.    | 2-point discrimination + data discussion         | ?? *(No good UT chapter...)*                                 |
