...
| -------- | ------------------------------------------------------------ | ------------------------------------------------ | ------------------------------------------------------------ |
| Aug 31   | Intro (cells, neurons, ions). Syllabus. Piazza. Resting membrane potential. | Live-test with SOME RESTING POTENTIAL LAB        | UT s1ch1. Coconut.                                           |
| Sep 7    | Action  potential. AP propagation.                           | *SPIKING MODEL TBC*                              | UT s1ch2. Pain.                                              |
| Sep 14   | Excitatory synapse. Terminology. Connectomics and escape in shrimp. | Eyewire lab?                                     | UT s1ch4, 5. Neurotic neurons.                               |
| Sep 21   | Inhibition. Integration. Ethology. Reflexes. Escape in fish. | Leech lab?                                       | M-cell review paper. Trying to be random. PAPER: M-cell in goldfish. |
| Sep 28   | Neurotransmitters. Central pattern  generators. STG. Locomotion in vertebrates. | ???                                              | UT s1ch0, s1ch6. List of neurotransmitters. CPG review paper. |
| Oct  5   | Intro to senses. Types of neural coding. Chemical senses.    | 2-point discrimination + data discussion         | ???                                                          |
...
| Oct 19   | Hearing: Maps. Owls. Speech  recognition. Neuroscience of music. | **TBC**                                          | Simplewriter. [Auditory neuroscience](http://auditoryneuroscience.com): ear and spatial hearing. Sound localization in owls (paper + reviews). Owl paper reading. |
