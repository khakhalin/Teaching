...
| Nov 23   | Cortex. Higher associative regions. Language areas. Left and right brains. Limbic system. Emotions. | *Thanksgiving*. *Draft  of the final paper due.*         | UT s4ch8 (Language): the very beginning of it (ignore details). Aphasias. UT s4ch5-6 (limbic system). |
