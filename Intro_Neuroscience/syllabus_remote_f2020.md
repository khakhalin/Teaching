...
| Sep 7    | Action  potential. AP propagation.                           | Working with literature?                         | UT s1ch2. Pain.                                              |
| Sep 14   | Excitatory synapse. Terminology. Connectomics and escape in shrimp. | Eyewire lab                                      | UT s1ch4, 5. Neurotic neurons.                               |
| Sep 21   | Inhibition. Integration. Neurotransmitters. Ethology.        | Zooniverse lab (tbc)                             | List of neurotransmitters. s1ch6. Animal behav paper.        |
| Sep 28   | Escape in fish. Central pattern  generators. STG. Reflexes. Locomotion. | Leech lab?                                       | UT s1ch0. CPG review paper. M-cell review paper. Trying to be random. PAPER: M-cell in goldfish. |
| Oct  5   | Intro to senses. Types of neural coding. Touch. Chemical senses. | 2-point discrimination + data discussion         | ?? *(No good UT chapter...)*                                 |
