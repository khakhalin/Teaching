...
| Nov 9    | Vision in the cortex. Brain morphology. Methods of  research. Motor systems. ~~Limbic system. Emotions.~~ _Claim final papers_ | Visual illusions                                             | UT s2ch1  (overview of organization). A list of keywords (basal ganglia, cerebellum). UT s3ch3  (motor cortex). Giraffe  paper. |
...
| Nov 23   | Cortex. Higher associative regions. Language areas. Left and right brains. Limbic system. Emotions. | *Thanksgiving*.                                              | UT s4ch8 (Language): the very beginning of it (ignore details). Aphasias. UT s4ch5-6 (limbic system). |
| Nov 30   | PFC, decision making. Frontal patients. Integrity of perception. Agency. Schizophrenia. | _Draft  of the final paper due: Mon Nov 30. Peer-review of final papers on Thu-Fri. Dec 3-4_ | UT s4ch9  (higher cortical functions). "Love hurts" paper. Geometrize |
| Dec 7    | *Advising week? TBC.*                                        | *Final paper due, Sat Dec 12*                                | tbc                                                          |
