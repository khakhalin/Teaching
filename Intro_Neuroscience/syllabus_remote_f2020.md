# Introduction to Neurobiology, Fall 2020
...
As we are still living through a pandemic, the course is taught online-only. The instruction will consist of several different independent parts:

* **Asynchronous** part:
  * **Assignments** (as well as all organizational info about the course) will be posted on **Piazza** (a special messaging board - see below).
  * **Lectures** will be posted on Youtube, with links on Piazza.
  * **Your participation** will also be gathered via Piazza. For the asynchronous part both sections of the course (all 50-60 people) will use the same messaging board.
* **Synchronous** part:
  ...
  * **Labs**: we have lab time scheduled (again, split into two different groups: one on Thursday, another one on Friday). We will Zoom during this time, and either do, or discuss stuff. We won't be zooming for the entire 3 hours, but on some weeks we may zoom in the beginning, then work alone for an hour, then zoom again. The details will follow (in the weekly plan, and on Piazza)
  * **Office hours**: tbc.

### Asynchronous part (Youtube & Piazza)

The main way of communication for this course is the [**Piazza** discussion board](https://piazza.com/). It's a dedicated social media-like place created specifically for this course (something in-between reddit, quora, oldschool forums, and stackexchange).
...
By default it will also send updates to your emails, but I believe you can tune these updates to your liking, in the preferences. 

### Synchronous part (Zoom)
...
If you miss more than 6 classes (labs and lectures combined) you will have to withdraw from the course. Please don't do it.
...
For the readings, UT s1ch1-2 stands for "[University of Texas free textbook](https://nba.uth.tmc.edu/neuroscience/toc.htm)" section 1, chapters 1 to 2.

| **Week** | Lectures                                                     | **Lab**                                                | Assignments and texts                                        |
| -------- | ------------------------------------------------------------ | ------------------------------------------------------ | ------------------------------------------------------------ |
| Aug 31   | Intro (cells, neurons, ions). Terminology. Syllabus. Piazza. | Live-test with SOME RESTING POTENTIAL LAB              | Syllabus. UT s1ch1. Neurotic neurons.                        |
| Sep 7    | Resting membrane potential. Action  potential. AP propagation. | *SPIKING MODEL TBC*                                    | UT s1ch2. Pain.                                              |
| Sep 14   | Excitatory synapse. Connectomics. Escape in shrimp.          | Eyewire lab                                            | UT s1ch4, 5.                                                 |
| Sep 21   | Inhibition. Integration. Neurotransmitters.                  | *Leech?*                                               | UT s1ch0, s1ch6. List of neurotransmitters.                  |
| Sep 28   | Reflexes. Escape in fish. Ethology.                          | M-paper reading                                        | M-cell review paper. Try to be random.                       |
| Oct  5   | Central pattern  generators. STG. Locomotion in vertebrates. Intro to senses. Types of neural coding. | 2-point discrimination + data discussion               | CPG review paper.                                            |
| Oct 12   | Hearing: ear and early processing.                           | *Some auditory lab* **TBC**                            | UT s2ch12  (hearing), glance through UT s2ch 13 (auditory pathways).  Videos: [ear](https://www.youtube.com/watch?v=PeTriGTENoc), [c.i.](https://www.youtube.com/watch?v=icPsm9RnO2E), [echo](https://www.youtube.com/watch?v=fnH7AIwhpik), [echo2](https://www.youtube.com/watch?v=Ybvg_ay6T50&t=18m57s). |
| Oct 19   | Hearing: Maps. Owls. Speech  recognition. Neuroscience of music. | Owl paper reading                                      | Simplewriter. [Auditory neuroscience](http://auditoryneuroscience.com): ear and spatial hearing. Sound localization in owls (paper + reviews). |
| Oct 26   | Vision: eye  and retina. Saccades. Color vision.             | Vision micro-labs + Visual illusions 1                 | UT s2ch14  (eye and retina). McGill retina. Dalton paper. Videos on  retinal vessels and white blood cells. |
| Nov 2    | On/off  cells, lateral inhibition, motion detection. Vision in the cortex. | Visual  illusions 2                                    | s2ch15 +  cortical column reading. Videos on neurobiology of toads. Dot-walker. |
| Nov 9    | Brain morphology. Methods of  research. Motor systems. Limbic system. Emotions. | *VISUAL LAG LAB?*. **TBC**                             | UT s2ch1  (overview of organization). A list of keywords (basal ganglia, cerebellum). QWOP. UT s3ch3  (motor cortex). UT s4ch5-6 (limbic system). Giraffe  paper. |
| Nov 16   | Brain development. Memory.                                   | Recursive drawing. Some complexity observable. **TBC** | UT s1ch7  (synaptic plasticity); LTP and patch-clamp. UT s1ch9 (synapse formation and elimination). |
...
| Nov 30   | PFC, decision making. Frontal patients. Integrity of perception. Agency. Schizophrenia. | ?                                                      | UT s4ch9  (higher cortical functions). "Love hurts" paper. [Geometrize](http://www.samcodes.co.uk/project/geometrize-haxe-web/). |
...
There will be a deadline to submit a draft version of your essay. If you submit something by this deadline, I will read your draft, and give you some feedback. We can also meet during drop-in hours, to talk about your project (it's not required, but we may, if you prefer to).
